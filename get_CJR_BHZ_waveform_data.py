...
try:
 wave1 = NIEP_client.get_waveforms('RO', 'CJR', '--', 'BHZ', start.replace(minute=0, second=1), endtime)
 wave1.filter('highpass', freq=4, corners=2, zerophase=True)
 ...
 wave1.plot(type="dayplot", interval=30, size=(1250, 1000), dpi=164, number_of_ticks=6, tick_rotation=45,
