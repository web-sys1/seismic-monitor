...
"""
wave1.filter("bandpass", freqmin=0.22, freqmax=24.85, corners=3, zerophase=False)
...
wave1.filter("bandpass", freqmin=0.19, freqmax=25.90, corners=2, zerophase=False)
wave1.detrend(type='demean')
wave1.detrend(type='linear')
wave1.plot(type="dayplot", interval=30, size=(1360, 1060), dpi=170, number_of_ticks=6, tick_rotation=45,
        right_vertical_labels=False,
        vertical_scaling_range=5e3-3e3, one_tick_per_line=True,
        color=['k', 'r', 'b', 'g'], show_y_UTC_label=True, outfile='public/waveforms/RO/RO_12H_MLR_HHZ.png')
