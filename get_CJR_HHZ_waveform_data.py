...
try:
 wave1 = NIEP_client.get_waveforms('RO', 'CJR', '--', 'HHZ', start.replace(minute=0, second=1), endtime)
 ...
 wave1.plot(type="dayplot", interval=30, size=(1360, 1060), dpi=164, number_of_ticks=6, tick_rotation=45,
        ...
        vertical_scaling_range=18000, one_tick_per_line=True,
        color=['k', 'r', 'b', 'g'], show_y_UTC_label=True,
        outfile='public/waveforms/RO/RO_12H_CJR_HHZ.png')
